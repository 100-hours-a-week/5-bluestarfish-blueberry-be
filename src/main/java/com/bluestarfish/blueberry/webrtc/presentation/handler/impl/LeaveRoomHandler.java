...
@Component(value = "leaveRoom")
public class LeaveRoomHandler extends MessageHandler {

    @Autowired
    public LeaveRoomHandler(WebRTCRoomManager webRTCRoomManager, WebRTCUserRegistry webRTCUserRegistry) {
    ...
    public void handleMessage(JsonObject jsonMessage, WebSocketSession webSocketSession) throws IOException {
        ...
        webRTCRoomManager.leaveRoom(userSession);
    }
}
